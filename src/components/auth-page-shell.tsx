...
export function AuthPageShell({
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-5 py-8 sm:max-w-lg">
      ...
      <div className="my-7 rounded-2xl border border-brand-200 bg-brand-50 px-4 py-3 text-brand-700 shadow-sm">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-200/70 dark:border-slate-700 dark:bg-slate-900 dark:shadow-none">
        <div className="mb-4 grid grid-cols-2 rounded-full bg-slate-100 p-1 dark:bg-slate-800">
          <Link
            href="/login"
